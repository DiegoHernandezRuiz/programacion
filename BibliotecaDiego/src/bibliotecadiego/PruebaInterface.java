...
public class PruebaInterface {
   ...
   public static void main(String[] args) {
        ...
        metodosA.imprimirAlumno((ArrayList<Alumno>) (List<Alumno>) lista);
        metodosL.Imprimir((ArrayList<Libro>) (List<Libro>) listLibro);
        metodosP.imprimirProfesor((ArrayList<Profesor>) listProfesor);
    ...
    public static void menuA(int opc) {
        ...
        switch (opc) {
            ...
            case 2 -> {
                System.out.println("Ingrese el numero de id");
                id = leer.nextInt();
                alumno = metodosA.buscarAlumno(1);
        ...
        switch (opc) {
            case 1 -> {
                while (Bandera) {
                    ...
                    metodosP.agregarProfesor(profesor);
                    profesor.setId(id);
                    id = id + 1;
            ...
            case 2 -> {
                while (Bandera) {
                    System.out.println("Ingrese el numero de id");
                    id = leer.nextInt();
                    profesor = metodosP.buscarProfesor(1);
                    ...
                    if (alumno == null) {
                        ...
                        System.out.println("Ingrese el genero");
                        profesor.setGenero(leer.next());
                        metodosP.actualizarProfesor(profesor);
                    }
            ...
            case 3 -> {
                while (Bandera) {
                    ...
                    if (alumno == null) {
                        ...
                        metodosP.eliminarProfesor(profesor);
                    }
